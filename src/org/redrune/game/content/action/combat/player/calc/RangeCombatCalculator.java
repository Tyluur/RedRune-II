...
public class RangeCombatCalculator implements CombatTypeCalculator {
	...
	public double totalAggressiveBoost(Player player, Object... params) {
		...
		double attackMultiplier = 1.0/* * e.getPrayer().getRangeMultiplier() * e.getAuraManager().getRangeAccurayMultiplier()*/; // TODO prayer multiplier
	...
	public double totalDefensiveBoost(Entity entity, Object... params) {
		if (entity.isPlayer()) {
			...
			double defenceMultiplier = 1.0; // TODO:  PRAYER MULTIPLIER /** (player ? ((Player) e).getPrayer().getDefenceMultiplier() : 1.0);*/
	...
	public double maximumDamageAppendable(Player player, Object... params) {
		...
		double effectiveStrength = Math.floor(rangedLvl/** player.getPrayer().getRangeMultiplier()*/) + styleBonus; // TODO: prayer multiplier
