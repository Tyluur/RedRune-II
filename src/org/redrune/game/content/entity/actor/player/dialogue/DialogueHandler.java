...
import org.redrune.game.content.entity.actor.player.dialogue.impl.*;
import org.redrune.game.entity.actor.npc.impl.others.Lucien;
...
public final class DialogueHandler {
	...
	public static void init() {
		try {
			...
			System.out.println("Loaded " + CACHED_DIALOGUES.size() + " game dialogues");
