...
public class IoWriteEvent implements IoHeap {
	 ...
	 * @return This OutgoingPacket instance, for chaining.
	 */
	public IoWriteEvent writeByteA(int val) {
		buffer.writeByte((byte) (val + 128));
		return this;
	}
	 ...
	 * @return This OutgoingPacket instance, for chaining.
	 */
	public IoWriteEvent writeByteS(int val) {
		buffer.writeByte((byte) (128 - val));
		return this;
	}
	 ...
	 * @return This OutgoingPacket instance, for chaining.
	 */
	public IoWriteEvent writeByteC(int val) {
		buffer.writeByte((byte) -val);
		return this;
	}
	 ...
	 * @return This OutgoingPacket instance, for chaining.
	 */
	public IoWriteEvent writeInt2(int val) {
		buffer.writeByte((byte) (val >> 16));
		buffer.writeByte((byte) (val >> 24));
		buffer.writeByte((byte) val);
		buffer.writeByte((byte) (val >> 8));
