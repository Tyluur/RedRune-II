 ...
 * @since 8/9/2017
 */
public class StatusUpdatePacketOut extends WriteablePacket {
	...
	public StatusUpdatePacketOut(String username, boolean online, byte privateStatus, byte worldId) {
		super(STATUS_UPDATE_PACKET_ID);
