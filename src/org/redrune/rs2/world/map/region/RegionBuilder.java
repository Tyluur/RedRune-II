...
public class RegionBuilder {
	...
	public static GameObject addObject(GameObject object, boolean ignoreObjects) {
		...
		if (object.getType() == 22) {
			...
			if (def.getActionCount() != 0) {
				addClippingForVariableObject(object.getLocation().getX(), object.getLocation().getY(), object.getLocation().getZ(), object.getType(), object.getRotation(), def.isSolid(), !def.isClippingFlag());
			}
		}
		if (!ignoreObjects) {
