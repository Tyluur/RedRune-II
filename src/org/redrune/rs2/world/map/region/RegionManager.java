...
public class RegionManager {
	...
	public static Region forCoords(int hash) {
		return REGION_CACHE.computeIfAbsent(hash, h -> new Region(h >> 8, h & 0xFF, REGION_SIZE));
	}
	...
	public static boolean isBasicClipped(Location l) {
		...
		return (clippingMask & 0x1280180) == 0 && (clippingMask & 0x1280108) == 0 && (clippingMask & 0x1280120) == 0 && (clippingMask & 0x1280102) == 0;
	}
