...
public final class NPCDefinitionParser {
	...
	private static final ConcurrentHashMap<Integer, NPCDefinitionParser> npcDefinitions = new ConcurrentHashMap<>();
	...
	public NPCDefinitionParser(int id) {
		this.id = id;
		anInt842 = -1;
		anInt844 = -1;
		anInt837 = -1;
	...
	public static NPCDefinitionParser getNPCDefinitions(int npcId) {
		NPCDefinitionParser def = npcDefinitions.get(npcId);
		if (def == null) {
			def = new NPCDefinitionParser(npcId);
			def.method694();
			try {
