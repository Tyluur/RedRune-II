...
public final class MainFile {
    ...
    MainFile(int id, RandomAccessFile data, RandomAccessFile index, byte[] readCachedBuffer, boolean newProtocol) throws IOException {
        this.id = id;
        this.data = data;
        this.index = index;
