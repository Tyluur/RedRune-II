			...
			case 387:
				if (componentId == 39) {
					if (player.getInterfaceManager().containsScreenInter()) {
						player.getPackets().sendMessage("Please finish what you're doing before opening your equipment bonuses.");
						return true;
					}
				...
				if (componentId == 42) {
					if (player.getInterfaceManager().containsScreenInter()) {
						player.getPackets().sendMessage("Please finish what you're doing before opening the price checker.");
						return true;
					}
					player.stopAll();
				...
				if (componentId == 45) {
					if (player.getInterfaceManager().containsScreenInter()) {
						player.getPackets().sendMessage("Please finish what you're doing before opening your items kept on death.");
						return true;
					}
					player.stopAll();
