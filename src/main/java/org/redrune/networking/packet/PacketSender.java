...
public class PacketSender {
     ...
     *
     * @param slot       The slot of the grand exchange offer
     * @param progress   The progress bar Id
     * @param item       The item identification number used to display the item
     * @param price      The price of the item.
     * @param amountSold The progress percentage of the offer being completed
     */
