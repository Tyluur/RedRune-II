...
public final class Misc {
     ...
     */
    public static String formatIp(String unformatted) {
     ...
     *
     * @param eventTime   The time the certain event happened
     * @param timeToCheck The amount of time that should have elapsed
     */
        ...
        for (File file : files) {
            ...
            if (file.isDirectory()) {
                ...
                try {
                    ...
                    Object objectEvent = (aClass.newInstance());
