...
public class PunishmentHandler {
     ...
     * @param name   The punished users name
     * @param type   The type of punishment
     * @param hours  The duration of the punishment
     */
     ...
     * @param add        If the punishment was added or removed
     * @param success    if the punishment was successful or failed
     */
     ...
     *
     * @param punishment The punishment to ad
