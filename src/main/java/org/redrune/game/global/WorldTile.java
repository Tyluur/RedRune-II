...
public class WorldTile implements Serializable {
     ...
     * Returns a location.
     *
     * @param diffX The amount to increase the current x-coordinate with.
     * @param diffY The amount to increase the current y-coordinate with.
     * @param diffZ The amount to increase the current height with.
     * @return The location.
     */
     ...
     *
     * @param other The delta location.
     * @return The location.
     */
     ...
     *
     * @param tile The location argued.
     * @return The distance.
     */
