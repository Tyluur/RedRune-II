package org.redrune.game.content.entity.actor.player.cutscene.impl;

import org.redrune.game.content.entity.actor.player.cutscene.Cutscene;
import org.redrune.game.content.entity.actor.player.cutscene.actions.*;
...
public class HomeCutScene extends Cutscene {
    ...
    public CutsceneAction[] getActions(Player player) {
        ...
        actionsList.add(new MovePlayerAction(10, 0, 0, MagicConstants.TELE_MOVE_TYPE, 0)); // out
        ...
        actionsList.add(new MovePlayerAction(10, 6, 0, MagicConstants.TELE_MOVE_TYPE, -1));
        ...
        actionsList.add(new MovePlayerAction(16, 29, 0, MagicConstants.TELE_MOVE_TYPE, 0));
