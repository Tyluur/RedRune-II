package org.redrune.game.content.entity.actor.player.skills.mining;
...
public final class Mining extends Action {
    ...
    public int processWithDelay(Player player) {
        ...
        if (!usedDeplateAurora && (1 + Math.random()) < player.getAuraManager().getChanceNotDepleteMN_WC()) {
            ...
            RegionManager.spawnTemporaryObject(new WorldObject(definitions.getEmptyId(), rock.getType(), rock.getRotation(), rock.getX(), rock.getY(), rock.getPlane()), definitions.respawnDelay * 600L);
