package org.redrune.game.content.entity.actor.player.skills.fletching;
...
public class Fletching extends Action {
    ...
    public boolean start(Player player) {
        ...
        player.getPackets().sendMessage("You attempt to create a " + new Item(fletch.getProduct()[option]).getDefinitions().getName().replace("(u)", "") + "...", true);
        return true;
    }
    ...
    public int processWithDelay(Player player) {
        ...
        player.getPackets().sendMessage("You successfully create a " + new Item(fletch.getProduct()[option]).getDefinitions().getName().replace("(u)", "") + ".", true);
