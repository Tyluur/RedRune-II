...
public class MagicCombatStyle extends AbstractCombatStyle {
     ...
     * @param plugin The magic spell event
     ...
     * @param target        The target
     * @param plugin        The magic spell event
     * @param spellCastTask The task that is executed when the spell is cast
     * @param hitLandTask   The task that is executed when the hit lands.
     ...
     * @param player        The player
     * @param target        The target
     * @param plugin        The event
     * @param spellCastTask The task for when the spell is cast
     * @param hitLandTask   The task for when the hit lands
     */
