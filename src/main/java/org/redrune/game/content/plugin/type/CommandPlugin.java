...
public abstract class CommandPlugin implements Plugin {
     ...
     * @param console       If the command is a console command
     * @param clientCommand If the command was sent via an automatic client system
     */
     ...
     * @param args        The parameters
     * @param slot        The slot
     * @param defaultType The default return
     */
     ...
     *
     * @param unformattedUsername The username
     */
