...
public interface InterfacePlugin extends Plugin {
     ...
     * @param componentId The component id of the interface
     * @param itemId      The item id on the interface, -1 if none.
     * @param slotId      The slot id on the interface, -1 if none.
     * @param packetId    The packet id of the click, different ids are used for different options
     ...
     *
     * @param interfaceIds The id of the interfaces that will be registered
     */
