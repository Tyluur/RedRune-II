    ...
    public void useBookEmote(int id) {
        ...
        if (!unlockedEmotes.contains(id)) {
            ...
            if (Misc.currentTimeMillis() < nextEmoteEnd) {
                player.getPackets().sendMessage("You're already doing an emote!");
                return;
            }
            if (id == 2) { // Yes
                ...
                switch (capeId) {
                    ...
                    case 20763: // Veteran cape
                        if (player.getControllerManager().getController() != null) {
                            player.getPackets().sendMessage("You cannot do this here!");
                            return;
                        }
                    ...
                    case 20767: // Max cape
                        if (player.getControllerManager().getController() != null) {
                            player.getPackets().sendMessage("This emote is currently unavailable.");
                            return;
                        }
                        ...
                        if (spawnTile == null) {
                            player.getPackets().sendMessage("Need more space to perform this skillcape emote.");
                            return;
                        }
                    ...
                    case 20771: // Completionist Cape
                        if (!RegionManager.canMoveNPC(player.getPlane(), player.getX(), player.getY(), 3)) {
                            ...
                            player.getPackets().sendMessage("Dont annoy other players!");
                            return;
                        }
                        ...
                        break;
                    default:
                        player.getPackets().sendMessage("You need to be wearing a skillcape in order to perform this emote.");
                        break;
                }
