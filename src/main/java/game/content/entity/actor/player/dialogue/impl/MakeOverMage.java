...
public class MakeOverMage extends Dialogue {
    ...
    public void run(int interfaceId, int componentId) {
        if (stage == -1) {
            ...
            stage = 1;
            options(DEFAULT_OPTION, "I would like a makeover", "I would like a haircut", "I would like a clothing change", "I would like an entire re-design.");
        } else if (stage == 1) {
            switch (componentId) {
                case FIRST:
                ...
                case THIRD:
                    ...
                    break;
                case FOURTH:
                    player(NORMAL, "I would like an entire re-design.");
                    stage = 25;
                    break;
            }
        } else if (stage == 2) {
