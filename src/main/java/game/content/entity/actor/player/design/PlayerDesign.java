package game.content.entity.actor.player.design;

import game.content.entity.actor.player.design.DefaultDesign.DefaultSubDesign;
import game.content.entity.actor.player.design.DesignState.CustomizeCategory;
import game.content.entity.actor.player.design.DesignState.InterfaceState;
import game.entity.actor.player.Player;
import game.entity.actor.player.data.PlayerAppearance;
import utility.constants.DesignConstants;
...
public class PlayerDesign {
	...
	public static void handle(Player player, int buttonId, int slot) {
		...
		if (state == null) {
			...
			player.putTemporaryAttribute("design_state", state);
		}
		switch (buttonId) {
			case 115:
