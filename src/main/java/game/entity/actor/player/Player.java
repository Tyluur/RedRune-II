package game.entity.actor.player;

import engine.SystemManager;
import engine.tick.task.WorldTask;
import engine.tick.task.WorldTasksManager;
import game.content.entity.actor.player.action.ActionManager;
import game.content.entity.actor.player.controller.ControllerManager;
import game.content.entity.actor.player.cutscene.CutsceneManager;
import game.content.entity.actor.player.event.EventManager;
...
import game.content.entity.actor.player.skills.slayer.Slayer.SlayerMonsters;
import game.content.entity.item.Pots;
import game.entity.actor.Actor;
import game.entity.actor.data.CombatDefinitions;
...
import game.entity.actor.player.data.*;
import game.entity.actor.player.link.*;
import game.entity.actor.player.render.LocalNPCUpdate;
import game.entity.actor.player.render.LocalPlayerUpdate;
...
public class Player extends Actor {
    ...
    /**
     * The handler for all game {@link game.content.entity.actor.player.action.Action}s
     */
    private transient ActionManager actionManager;

    /**
     * The handler for all game {@link game.content.entity.actor.player.event.Event}s
     */
    private transient EventManager eventManager;

    /**
     * The handler for {@link game.content.entity.actor.player.cutscene.Cutscene}s
     */
