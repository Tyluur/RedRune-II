...
import game.content.entity.actor.combat.npc.NPCCombat;
...
import game.entity.actor.npc.mask.Transformation;
...
public class NPC extends Actor implements Serializable {
	...
	public NPC(int id, WorldTile tile, int mapAreaNameHash, boolean canBeAttackFromOutOfArea, boolean spawned) {
		...
		setFaceDirection(FaceDirection.NORTH.getValue());
	...
	public int getFlinchDelay() { return flinchDelay; }
