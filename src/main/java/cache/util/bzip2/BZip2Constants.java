...
/**
 * Base class for both the compress and decompress classes. Holds common arrays, and static data. <p> This interface is
 * public for historical purposes. You should have no need to use it. </p>
 */
public interface BZip2Constants {
	 ...
	 *
	 * <p>FIXME: This array should be in a private or package private location, since it could be modified by malicious
	 * code.</p>
	 */
