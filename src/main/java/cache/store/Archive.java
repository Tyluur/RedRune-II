...
import cache.io.OutputStream;
import cache.util.bzip2.BZip2Compressor;
import cache.util.bzip2.BZip2Decompressor;
import cache.util.crc32.CRC32HGenerator;
import cache.util.gzip.GZipCompressor;
import cache.util.gzip.GZipDecompressor;
import cache.util.whirlpool.Whirlpool;
