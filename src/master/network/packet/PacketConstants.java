...
public interface PacketConstants extends MasterConstants {
	...
	/**
	 * The id of the private message attempt packet
	 */
	int PRIVATE_MESSAGE_ATTEMPT_PACKET_ID = 7;
	
	/**
	 * The id of the private message delivery packet
	 */
	int PRIVATE_MESSAGE_DELIVERY_PACKET_ID = 8;
	
	/**
	 * The id of the private message receive packet
	 */
	int PRIVATE_MESSAGE_RECEIVE_PACKET_ID = 9;
