...
public final class NPCCombatDefinitionsL {
	...
	private static NPCCombatDefinitions DEFAULT_DEFINITION = new NPCCombatDefinitions(1, -1, -1, -1, 5, 1, 1, 0, NPCCombatDefinitions.MELEE, -1, -1, NPCCombatDefinitions.PASSIVE);
	
	private static String PACKED_PATH = "data/repository/npc/packedCombatDefinitions.ncd";
	...
	private static void loadUnpackedNPCCombatDefinitions() {
		...
		try {
			...
			BufferedReader in = new BufferedReader(new FileReader("data/repository/npc/unpackedCombatDefinitionsList.txt"));
			while (true) {
