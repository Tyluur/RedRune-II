...
public final class NPCBonuses {
	...
	private static final String PACKED_PATH = "data/repository/npc/packedBonuses.nb";
	...
	private static void loadUnpackedNPCBonuses() {
		System.out.println("Packing npc bonuses...");
		try {
			DataOutputStream out = new DataOutputStream(new FileOutputStream(PACKED_PATH));
			BufferedReader in = new BufferedReader(new FileReader("data/repository/npc/unpackedBonuses.txt"));
			while (true) {
