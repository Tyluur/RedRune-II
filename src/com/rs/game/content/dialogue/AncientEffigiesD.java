...
public class AncientEffigiesD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			sendDialogue(SEND_2_TEXT_INFO, "Images from your experiences of "
					+ AncientEffigies.getMessage(skill1), "fill your mind.");
			stage = 0;
		} else if (stage == 0) {
			...
			if (player.getSkills().getLevel(
				...
				sendDialogue(
						SEND_3_TEXT_INFO, "The images in your mind fade; the ancient effigy seems", "to desire knowledge of experiences you have not yet", "had.");
				player.getPackets()
						.sendGameMessage(
