...
import com.rs.game.content.skills.slayer.Slayer.Master;
import com.rs.game.content.skills.slayer.Slayer.SlayerTask;
		...
		if (stage == -1) {
			...
			sendEntityDialogue(SEND_4_OPTIONS, new String[] {
					...
					"Where are you located in the land of "
							+ GameConstants.SERVER_NAME + "?", "Give me a tip.",
