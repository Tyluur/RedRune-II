		...
		switch (Misc.getRandom(3)) {
			case 0: // Melee
				if (npc.withinDistance(target, 3)) {
					...
					} else if ((!Combat.hasAntiDragProtection(target) || !player.getPrayer().usingPrayer(0, 17) || !player.getPrayer().usingPrayer(1, 7)) && player.getFireImmune() > Misc.currentTimeMillis()) {
