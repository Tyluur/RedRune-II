package com.rs.game.content.minigame;
...
import com.rs.game.entity.actor.npc.impl.others.CastleWarBarricade;
import com.rs.game.entity.actor.player.data.Equipment;
import com.rs.game.entity.actor.player.Player;
import com.rs.game.content.controler.impl.minigame.CastleWarsPlaying;
import com.rs.game.content.dialogue.CastleWarsScoreboard;
	...
	private static class PlayingGame extends TimerTask {
		...
		public void reset() {
			...
			for (WorldObject object : spawnedObjects)
				World.destroySpawnedObject(object, object.getId() != 4377 && object.getId() != 4378);
