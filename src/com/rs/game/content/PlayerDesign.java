...
public class PlayerDesign {
	 ...
	 */
	private static final PlayerDesign[] MALE_SET1 = { new PlayerDesign(new short[] { -1, -1, 473, 616, 392, 648, 441, -1 }, new short[] { -1, 44, 220, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 443, -1, 390, 646, 440, -1 }, new short[] { -1, 44, 220, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 474, 618, 394, 650, 441, -1 }, new short[] { -1, 44, 220, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET2 = { new PlayerDesign(new short[] { -1, -1, 453, -1, 380, 636, 429, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 454, -1, 381, 637, 429, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 455, -1, 382, 638, 429, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET3 = { new PlayerDesign(new short[] { -1, -1, 447, -1, 386, 642, 429, -1 }, new short[] { -1, 132, 132, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 448, -1, 387, 643, 429, -1 }, new short[] { -1, 132, 132, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 449, -1, 388, 644, 429, -1 }, new short[] { -1, 132, 132, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET4 = { new PlayerDesign(new short[] { -1, -1, 469, 607, 383, 639, 431, -1 }, new short[] { -1, 156, 149, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 470, 608, 384, 640, 429, -1 }, new short[] { -1, 156, 149, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 450, -1, 385, 641, 429, -1 }, new short[] { -1, 156, 149, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET5 = { new PlayerDesign(new short[] { -1, -1, 452, -1, 371, 627, 434, -1 }, new short[] { -1, 196, 196, 39, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET6 = { new PlayerDesign(new short[] { -1, -1, 461, 593, 369, 625, 432, -1 }, new short[] { -1, 84, 77, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] MALE_SET7 = { new PlayerDesign(new short[] { -1, -1, 446, -1, 374, 630, 429, -1 }, new short[] { -1, 116, 116, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET1 = { new PlayerDesign(new short[] { -1, -1, 586, 423, 535, 503, 553, -1 }, new short[] { -1, 60, 60, 155, 0, 0, 0, 0, 0, 0 }),
			
			new PlayerDesign(new short[] { -1, -1, 585, 422, 534, 502, 554, -1 }, new short[] { -1, 52, 221, 4, 0, 0, 0, 0, 0, 0 }),
			
			new PlayerDesign(new short[] { -1, -1, 587, 425, 537, 505, 551, -1 }, new short[] { -1, 60, 60, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET2 = { new PlayerDesign(new short[] { -1, -1, 562, -1, 523, 491, 551, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 563, -1, 524, 492, 551, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 564, -1, 525, 493, 551, -1 }, new short[] { -1, 204, 201, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET3 = { new PlayerDesign(new short[] { -1, -1, 581, 417, 529, 497, 551, -1 }, new short[] { -1, 132, 132, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 582, 418, 530, 498, 551, -1 }, new short[] { -1, 132, 128, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 557, -1, 531, 499, 551, -1 }, new short[] { -1, 132, 132, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET4 = { new PlayerDesign(new short[] { -1, -1, 579, 414, 526, 494, 551, -1 }, new short[] { -1, 156, 156, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 559, -1, 527, 495, 551, -1 }, new short[] { -1, 156, 149, 4, 0, 0, 0, 0, 0, 0 }), new PlayerDesign(new short[] { -1, -1, 580, 416, 528, 496, 552, -1 }, new short[] { -1, 156, 149, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET5 = { new PlayerDesign(new short[] { -1, -1, 561, -1, 514, 482, 545, -1 }, new short[] { -1, 196, 196, 39, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET6 = { new PlayerDesign(new short[] { -1, -1, 570, 400, 512, 480, 543, -1 }, new short[] { -1, 84, 77, 4, 0, 0, 0, 0, 0, 0 }) };
	
	private static final PlayerDesign[] FEMALE_SET7 = { new PlayerDesign(new short[] { -1, -1, 574, 405, 517, 485, 548, -1 }, new short[] { -1, 116, 116, 4, 0, 0, 0, 0, 0, 0 }) };
	...
	public static void open(Player player) {
		...
		player.getPackets().sendAccessMask(0, 11, 1028, 65, 2);
		player.getPackets().sendAccessMask(0, 204, 1028, 132, 2);
		player.getPackets().sendAccessMask(0, 33, 1028, 128, 2);
	}
