...
import com.rs.utility.constants.ItemConstants;
...
public class TradeManager {
	...
	public void sendValue(int slot, boolean traders) {
		...
		player.getPackets().sendGameMessage(item.getDefinitions().getName() + ": market price is " + item.getDefinitions().getValue() + " coins.");
	}
