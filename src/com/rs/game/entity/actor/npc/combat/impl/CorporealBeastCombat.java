			...
			if (target instanceof Player) {
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						skill = skill == 0 ? PlayerSkills.MAGIC : (skill == 1 ? PlayerSkills.SUMMONING : PlayerSkills.PRAYER);
						...
						player.getPackets().sendGameMessage("Your " + PlayerSkills.SKILL_NAME[skill] + " has been slighly drained!");
					}
